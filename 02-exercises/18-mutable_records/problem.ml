...
let advance_color stoplight = match stoplight with
| {color = Green; _} -> set_color stoplight Yellow
| {color = Yellow; _} -> set_color stoplight Red
| {color = Red; _} -> set_color stoplight Green
